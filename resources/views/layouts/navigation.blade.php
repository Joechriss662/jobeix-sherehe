<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 shadow">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('pledges.index')" :active="request()->routeIs('pledges.index')">
                        {{ __('Pledges') }}
                    </x-nav-link>
                    ...
                    @role('admin')
                        <x-nav-link :href="route('users.index')">User Management</x-nav-link>
                    @endrole
                </div>
            </div>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('pledges.index')" :active="request()->routeIs('pledges.index')">
                {{ __('Pledges') }}
            </x-responsive-nav-link>
