...
<div class="container py-5">
    <h4 class="mb-4 text-center">{{ __('Add New Guest') }}</h4>
    ...
    <form action="{{ route('guests.store-independent') }}" method="POST">
        @csrf
        <div class="mb-3">
        ...
        <button type="submit" class="btn btn-primary w-100">{{ __('Add Guest') }}</button>
    </form>
</div>
@endsection